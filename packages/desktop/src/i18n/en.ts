export const dict = {
  ...
  "desktop.menu.help.documentation": "FangCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "FangCode CLI binary is missing. Try reinstalling the desktop app.",
