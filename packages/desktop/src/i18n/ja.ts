export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの FangCode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "FangCode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'FangCode' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "FangCode ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "FangCode CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
