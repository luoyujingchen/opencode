---
title: LSP Servers
description: FangCode integrates with your LSP servers.
---

FangCode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

FangCode comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and fangcode opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your fangcode config.
