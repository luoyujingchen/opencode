...
describe("installation", () => {
  describe("latest", () => {
    test("reads release version from xiaofang release api", async () => {
    ...
    test("strips v prefix from xiaofang release tag", async () => {
    ...
    test("uses the same release source for npm installs", async () => {
      const layer = testLayer(() => jsonResponse({ tag_name: "v1.5.0" }))
