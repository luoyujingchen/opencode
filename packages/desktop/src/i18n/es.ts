export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de FangCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de FangCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de FangCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de FangCode. Intenta reinstalar la aplicación de escritorio.",
