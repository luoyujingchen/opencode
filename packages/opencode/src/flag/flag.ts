...
export namespace Flag {
  ...
  export const FANG_DISABLE_AUTOUPDATE = true
  ...
  export const FANG_DISABLE_MODELS_FETCH = true
  ...
  export const FANG_MODELS_URL = string(...P("MODELS_URL"))
...
Object.defineProperty(Flag, "OPENCODE_PLUGIN_META_FILE", {
  get() {
    return process.env["FANG_PLUGIN_META_FILE"] ?? process.env["OPENCODE_PLUGIN_META_FILE"]
  },
  enumerable: true,
  configurable: false,
})
Object.defineProperty(Flag, "FANG_PLUGIN_META_FILE", {
  get() {
    return Flag.OPENCODE_PLUGIN_META_FILE
  },
  enumerable: true,
  configurable: false,
})
