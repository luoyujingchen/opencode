...
You can add custom commands through the FangCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your FangCode [config](/docs/config):
...
- Global: `~/.config/fangcode/commands/`
- Per-project: `.opencode/commands/`

```markdown title="~/.config/fangcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
fangcode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
