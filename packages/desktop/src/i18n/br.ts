export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do FangCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do FangCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do FangCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do FangCode está ausente. Tente reinstalar o aplicativo de desktop.",
