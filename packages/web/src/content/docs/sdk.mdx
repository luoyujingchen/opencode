---
title: SDK
description: Type-safe JS client for fangcode server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The fangcode JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control fangcode programmatically.
...
Create an instance of fangcode:

```javascript
import { createOpencode } from "@fangcode/sdk"
...
const fangcode = await createOpencode({
  hostname: "127.0.0.1",
  port: 4096,
  config: {
...
If you already have a running instance of fangcode, you can create a client instance to connect to it:

```javascript
import { createOpencodeClient } from "@fangcode/sdk"
...
```typescript
import type { Session, Message, Part } from "@fangcode/sdk"
```
...
const textResults = await client.find.text({
  query: { pattern: "function.*fangcode" },
})
