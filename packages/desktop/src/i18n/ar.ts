export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من FangCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من FangCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق FangCode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف FangCode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
