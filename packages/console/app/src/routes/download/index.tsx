      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://fangcode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>fangcode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g fangcode")}>
                <code>
                  npm i -g <strong>fangcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g fangcode")}>
                <code>
                  bun add -g <strong>fangcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/fangcode")}>
                <code>
                  brew install <strong>anomalyco/tap/fangcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S fangcode")}>
                <code>
                  paru -S <strong>fangcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask fangcode-desktop")}>
                <code>
                  brew install --cask <strong>fangcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
