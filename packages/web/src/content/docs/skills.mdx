...
Agent skills let FangCode discover reusable instructions from your repo or home directory.
...
FangCode searches these locations:

- Project config: `.opencode/skills/<name>/SKILL.md`
- Global config: `~/.config/fangcode/skills/<name>/SKILL.md`
...
For project-local paths, FangCode walks up from your current working directory until it reaches the git worktree.
...
Global definitions are also loaded from `~/.config/fangcode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md`, and `~/.agents/skills/*/SKILL.md`.
...
FangCode lists available skills in the `skill` tool description.
