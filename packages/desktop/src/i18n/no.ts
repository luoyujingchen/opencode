export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av FangCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av FangCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "FangCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "FangCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
