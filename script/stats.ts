...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/fangcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/fangcode...\n")
...
console.log("Fetching npm all-time downloads for fangcode...\n")
const npmDownloads = await fetchNpmDownloads("fangcode")
