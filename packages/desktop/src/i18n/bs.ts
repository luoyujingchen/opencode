export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju FangCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} FangCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'FangCode'.",
  ...
  "desktop.menu.help.documentation": "FangCode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka FangCode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
