...
Generates UPCOMING_CHANGELOG.md by running the FangCode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for FangCode run (default: low)
      --quiet            Suppress FangCode command output unless it fails
