export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by FangCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in FangCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "FangCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "fangcode.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in FangCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in FangCode.",
  ...
  "dialog.server.description": "Switch which FangCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "FangCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking FangCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking FangCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating FangCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating FangCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update FangCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update FangCode",
  "wsl.onboarding.opencodeReadyIn": "FangCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "FangCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install FangCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install FangCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "FangCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before FangCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "FangCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen FangCode.",
  ...
  "toast.update.description": "A new version of FangCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the FangCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, FangCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "FangCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "FangCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the FangCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for FangCode",
  ...
  "settings.general.row.appearance.description": "Customise how FangCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether FangCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how FangCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when FangCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of FangCode.",
