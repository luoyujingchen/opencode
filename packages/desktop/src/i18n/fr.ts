export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'FangCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'FangCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'FangCode'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'FangCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI FangCode est manquant. Essayez de réinstaller l'application de bureau.",
