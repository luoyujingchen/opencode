export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию FangCode",
  ...
  "desktop.updater.downloaded.prompt": "Версия FangCode {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'FangCode'.",
  ...
  "desktop.menu.help.documentation": "Документация FangCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл FangCode CLI. Попробуйте переустановить настольное приложение.",
