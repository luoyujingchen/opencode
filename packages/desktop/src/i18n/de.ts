export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von FangCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von FangCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'FangCode' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "FangCode-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das FangCode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
