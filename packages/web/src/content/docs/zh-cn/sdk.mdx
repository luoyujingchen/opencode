---
title: SDK
description: fangcode 服务器的类型安全 JS 客户端。
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

fangcode JS/TS SDK 提供了一个类型安全的客户端，用于与服务器进行交互。
你可以用它来构建集成方案，并以编程方式控制 fangcode。
...
如果你已经有一个正在运行的 fangcode 实例，可以创建一个客户端实例来连接它：
