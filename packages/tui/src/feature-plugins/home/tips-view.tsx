...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public FangCode link",
  ...
  "Use {highlight}fang run{/highlight} for non-interactive scripting",
  "Use {highlight}fang --continue{/highlight} to resume the last session",
  "Use {highlight}fang run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}fang serve{/highlight} for headless API access to FangCode",
  "Use {highlight}fang run --attach{/highlight} to connect to a running server",
  "Run {highlight}fang upgrade{/highlight} to update to the latest version",
  "Run {highlight}fang auth list{/highlight} to see all configured providers",
  "Run {highlight}fang agent create{/highlight} for guided agent creation",
  "Use {highlight}/fangcode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}fang github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}fang debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/fangcode{/highlight} in a container",
