---
title: Share
description: Share your FangCode conversations.
---

FangCode's share feature allows you to create public links to your FangCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, FangCode:
...
FangCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, FangCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using fangcode in your organization.
